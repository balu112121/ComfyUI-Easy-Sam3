...
def load_resource_as_video_frames(
    ...
    if isinstance(resource_path, list):
        img_mean = torch.tensor(img_mean, dtype=torch.bfloat16)[:, None, None]
        img_std = torch.tensor(img_std, dtype=torch.bfloat16)[:, None, None]
        ...
        for img_pil in resource_path:
            ...
            # bfloat16 to match model's autocast dtype
